      ...
      recargas.forEach(recarga => {
        ...
        <div class="px-5 pb-5">
            ...
            <div class="flex items-center justify-between">
                ...
                <a ${`href="https://api.whatsapp.com/send?phone=55${whatsapp}&text=Olá, gostaria da ${recarga.titulo.toLowerCase()}"`} target="_blank" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-red-800">comprar</a>
            </div>
        </div></div>
          `
      })
